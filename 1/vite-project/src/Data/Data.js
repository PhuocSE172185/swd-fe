  ...
  export const headerBooks =[
      {
          ...
          info: 'Beyond Good and Evil confirmed Nietzsches position as the towering European philosopher of his age. The work dramatically rejects the tradition of Western thought with its notions of truth and God, good and evil.',
          btnLink: '*',
          epubFile: 'beyond-good-and-evil.epub'
      },
      {
          id: 2,
          img: HBook2,
          title:'The Island of Dr. Moreau',
          info: ' In The Island of Dr. Moreau a shipwrecked gentleman named Edward Prendick, stranded on a Pacific island lorded over by the notorious Dr. Moreau, confronts dark secrets, strange creatures, and a reason to run for his life.',
          btnLink: '*',
          epubFile: 'the-island-of-doctor-moreau.epub'
      },
      {
          id: 3,
          img: HBook3,
          title:'Alice Adventures in Wonderland',
          info: "Based on Walt Disneys animated classic, this vintage Little Golden Book from 1951 retells the story of Alice's wild adventures in Wonderland.",
          btnLink: '*',
          epubFile: 'alices-adventures-in-wonderland.epub'
      },
  ];
